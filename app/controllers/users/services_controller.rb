class Users::ServicesController < ApplicationController
  ...
  def create
    ...
    puts omniauth.inspect.magenta.bold
    ...
    if omniauth and params[:service]
      ...
      if service_route == 'facebook'
        ...
        email = '#{name}_email@example.com' # Twitter API never returns the email address
        ...
        omniauth['extra']['info']['email'] ? email = omniauth['extra']['info']['email'] : email = ''
        omniauth['extra']['info']['name'] ? name = omniauth['extra']['info']['name'] : name = ''
        omniauth['extra']['info']['id'] ? uid = omniauth['extra']['info']['id'] : uid = ''
        omniauth['provider'] ? provider = omniauth['provider'] : provider = ''
          ...
          if auth
            ...
            if email != ''
              ...
              if existinguser
                ...
                user = User.new :email => email, :password => SecureRandom.hex(10), :name => name, :login => email
                ...
                user.save
                puts user.errors.messages.inspect.yellow
                #user.confirm!
